...
var lang = "ru"; //for available codes see array availableLanguages in file GlobalOptions.js
...
var simpleWmsSearch = {
  ...
  gridColumns: [
    {header: 'Num', dataIndex: 'HOUSE', menuDisabled: 'true'},
    {header: 'Addr', dataIndex: 'ADDRESS', menuDisabled: 'true'}
  ],
